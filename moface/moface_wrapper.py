...
class MoFaceWrapper:
    ...
    def get_map(self, pose) -> Dict[str, Keypoint]:
        ...
        "eyebrow_end.l": Keypoint(x=pose[18][0], y=pose[18][1], z=pose[18][2], accuracy=pose[18][3], angle_vector=self.compute_vector(pose[18], pose[19])),
        ...
        "eyebrow_end.r": Keypoint(x=pose[25][0], y=pose[25][1], z=pose[25][2], accuracy=pose[25][3], angle_vector=self.compute_vector(pose[25], pose[24])),
